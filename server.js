...
app.use(cors({credentials: true, origin:"null", "https://jhirschi123.github.io"})); // only set origin null if it's on local host. When deploying change it to the client address jhirschi123.github.io
