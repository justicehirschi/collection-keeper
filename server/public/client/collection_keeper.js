var getCoins = function () {
    return fetch("collection-keeper-jhirschi.herokuapp.com/coins");
}
...
var deleteCoins = function (coin) {
    if(confirm("Are you sure you want to delete this coin?")) {
        return fetch("collection-keeper-jhirschi.herokuapp.com/coins/" + coin._id, {
            method: "DELETE",
            header: {
                "Content-type": "application/x-www-form-urlencoded"
            }
...
var editCoins = function (coin) {
    ...
    data += `&mint_mark=${encodeURIComponent(coin.mint_mark)}`;
    data += `&material=${encodeURIComponent(coin.material)}`;
    return fetch("collection-keeper-jhirschi.herokuapp.com/coins/" + coin.coin_id, {
        method: "PUT",
        headers: {
            "Content-type": "application/x-www-form-urlencoded"
        },
